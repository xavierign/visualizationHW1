...
data$Program [data$Program %in% c('QMSS', 'QMSS (master)')] <- "SS"
...
<br>
<br>
```{r fig.width=6, fig.height=4, echo=FALSE, fig.align='center',fig.cap='Most mentioned tools', cache=FALSE, message=FALSE, warning=FALSE}
library(xlsx)
data <- read.xlsx("/Users/xavierign/Dropbox/Columbia/Exploratory/VisualizationHW1/data_clean.xlsx", 1)
library(reshape2)
