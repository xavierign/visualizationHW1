...
<img src="/Users/xavierign/Dropbox/Columbia/Exploratory/VisualizationHW1/inter.png" style="width: 200px;"/>
<br>
<br>

```{r fig.width=6, fig.height=4, echo=FALSE, fig.align='center', cache=FALSE, fig.cap="Student programs by gender", message=FALSE, warning=FALSE}
library(xlsx)
...
library(reshape2)
data$Program [data$Program %in% c('Data Science', 'Data Science Certification', 'IDSE (master)', 'Ms in ds', 'MSDS') ] <- "DS"

data$Program [data$Program %in% c('QMSS', 'QMSS (master)')] <- "Social S."

data$Program [data$Program %in% c('Ph.D.', 'PhD Biomedical Informatics')] <- "PhD"

data$Program [data$Program %in% c('Applied Math', 'Statistics (master)')] <- "Math/Stats"
...
<br>
<br>
```{r fig.width=6, fig.height=4, echo=FALSE, fig.align='center',fig.cap='Age distribution by gender', cache=FALSE, message=FALSE, warning=FALSE}
library(reshape2)
library(ggthemes)
library(plyr)
library(ggplot2)
...
```{r, echo=FALSE, fig.height = 4, fig.width = 6, fig.align='center', fig.cap="Wordcloud of most mentioned tools"}
...
```{r, echo=FALSE, fig.height = 4, fig.width = 6 , fig.align="center", fig.cap="Most frequently mentioned tools"}
...
<br>
<br>
```{r fig.width=6, fig.height=4, echo=FALSE, fig.align='center', fig.cap='Program experiences by tool', cache=FALSE, message=FALSE, warning=FALSE}
library(xlsx)
data <- read.xlsx("/Users/xavierign/Dropbox/Columbia/Exploratory/VisualizationHW1/data_clean.xlsx", 1)
library(reshape2)
...
<br>
<br>
```{r fig.width=12, fig.height=4, echo=FALSE, fig.align='center',fig.cap='Bubble plot with knowledges and experiences', cache=FALSE, message=FALSE, warning=FALSE}
